...
Deep convolutional generative adversarial network (DCGAN) training learns to generate airfoils from a random vector input and the steepest descent optimization process  
