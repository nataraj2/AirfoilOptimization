...
Deep convolutional generative adversarial network (DCGAN) training learning to generate airfoils from a random vector input and the steepest descent optimization process  
